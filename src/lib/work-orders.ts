...
export const OFFICE_WORK_ORDER_VIEWS: WorkOrderView[] = [
  ...
  { key: "today", label: "Today", hint: "On the board for today, including anyone already on site.", buckets: ["today"] },
  { key: "needs_day", label: "Needs a day", hint: "No calendar slot yet. Put these on the board.", buckets: ["needs_day"] },
  { key: "upcoming", label: "Upcoming", hint: "On the board for a later day.", buckets: ["upcoming"] },
...
const BUCKET_TITLE: Record<WorkOrderBucket, string> = {
  ...
  today: "Today",
  needs_day: "Needs a day on the board",
  upcoming: "Upcoming",
